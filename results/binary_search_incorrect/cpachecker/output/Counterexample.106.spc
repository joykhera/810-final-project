CONTROL AUTOMATON ErrorPath106
...
STATE USEFIRST ARG62569 :
    MATCH "[target == arr[i]]" -> GOTO ARG62570;
    TRUE -> STOP;

STATE USEFIRST ARG62570 :
    MATCH "return i;" -> GOTO ARG62600;
    TRUE -> STOP;
...
STATE USEFIRST ARG62610 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (5);} GOTO ARG63295;
    TRUE -> STOP;
...
STATE USEFIRST ARG63484 :
    MATCH "0" -> GOTO ARG63583;
    TRUE -> STOP;
