CONTROL AUTOMATON ErrorPath103
...
STATE USEFIRST ARG62549 :
    MATCH "[target == arr[i]]" -> GOTO ARG62550;
    TRUE -> STOP;

STATE USEFIRST ARG62550 :
    MATCH "return i;" -> GOTO ARG62596;
    TRUE -> STOP;
...
STATE USEFIRST ARG62606 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (1);} GOTO ARG63291;
    TRUE -> STOP;
...
STATE USEFIRST ARG63481 :
    MATCH "0" -> GOTO ARG63580;
    TRUE -> STOP;

STATE USEFIRST ARG63580 :
