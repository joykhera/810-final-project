CONTROL AUTOMATON ErrorPath102
...
STATE USEFIRST ARG62544 :
    MATCH "[target == arr[i]]" -> GOTO ARG62545;
    TRUE -> STOP;

STATE USEFIRST ARG62545 :
    MATCH "return i;" -> GOTO ARG62595;
    TRUE -> STOP;
...
STATE USEFIRST ARG62605 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (0);} GOTO ARG63290;
    TRUE -> STOP;
...
STATE USEFIRST ARG63480 :
    MATCH "0" -> GOTO ARG63579;
    TRUE -> STOP;
