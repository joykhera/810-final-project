...
entry:
  call void @free(i8* bitcast (i32* @a to i8*)), !dbg !16
  ret i32 0, !dbg !17
}
...
!13 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 3, type: !14, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!14 = !DISubroutineType(types: !15)
!15 = !{!6}
!16 = !DILocation(line: 4, column: 2, scope: !13)
