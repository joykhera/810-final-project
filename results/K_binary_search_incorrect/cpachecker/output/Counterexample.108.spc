CONTROL AUTOMATON ErrorPath108
...
STATE USEFIRST ARG62579 :
    MATCH "[target == arr[i]]" -> GOTO ARG62580;
    TRUE -> STOP;

STATE USEFIRST ARG62580 :
    MATCH "return i;" -> GOTO ARG62602;
    TRUE -> STOP;
...
STATE USEFIRST ARG62612 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (7);} GOTO ARG63297;
    TRUE -> STOP;
...
STATE USEFIRST ARG63486 :
    MATCH "0" -> GOTO ARG63585;
    TRUE -> STOP;
