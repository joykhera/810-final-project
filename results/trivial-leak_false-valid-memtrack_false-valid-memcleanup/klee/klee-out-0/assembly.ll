...
entry:
  ...
  %call = call noalias align 16 i8* @malloc(i64 4) #3, !dbg !16
  %0 = bitcast i8* %call to i32*, !dbg !16
  store i32* %0, i32** %a, align 8, !dbg !15
  store i32* null, i32** %a, align 8, !dbg !17
  ret i32 0, !dbg !18
}
...
!1 = !DIFile(filename: "code.c", directory: "/results/trivial-leak_false-valid-memtrack_false-valid-memcleanup/klee")
!2 = !{}
...
!13 = !DILocalVariable(name: "a", scope: !9, file: !1, line: 4, type: !14)
!14 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!15 = !DILocation(line: 4, column: 7, scope: !9)
!16 = !DILocation(line: 4, column: 11, scope: !9)
!17 = !DILocation(line: 5, column: 4, scope: !9)
