CONTROL AUTOMATON ErrorPath110
...
STATE USEFIRST ARG62559 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62561;
    TRUE -> STOP;

STATE USEFIRST ARG62561 :
    MATCH "" -> GOTO ARG62562;
    TRUE -> STOP;

STATE USEFIRST ARG62562 :
    MATCH "++i" -> ASSUME {i == (4);} GOTO ARG62563;
    TRUE -> STOP;

STATE USEFIRST ARG62563 :
    MATCH "[i<len]" -> ASSUME {i == (4);len == (10);} GOTO ARG62564;
    TRUE -> STOP;

STATE USEFIRST ARG62564 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62566;
    TRUE -> STOP;
...
STATE USEFIRST ARG62567 :
    MATCH "++i" -> ASSUME {i == (5);} GOTO ARG62568;
    TRUE -> STOP;

STATE USEFIRST ARG62568 :
    MATCH "[i<len]" -> ASSUME {i == (5);len == (10);} GOTO ARG62569;
    TRUE -> STOP;

STATE USEFIRST ARG62569 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62571;
    TRUE -> STOP;

STATE USEFIRST ARG62571 :
    MATCH "" -> GOTO ARG62572;
    TRUE -> STOP;

STATE USEFIRST ARG62572 :
    MATCH "++i" -> ASSUME {i == (6);} GOTO ARG62573;
    TRUE -> STOP;

STATE USEFIRST ARG62573 :
    MATCH "[i<len]" -> ASSUME {i == (6);len == (10);} GOTO ARG62574;
    TRUE -> STOP;

STATE USEFIRST ARG62574 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62576;
    TRUE -> STOP;
...
STATE USEFIRST ARG62577 :
    MATCH "++i" -> ASSUME {i == (7);} GOTO ARG62578;
    TRUE -> STOP;

STATE USEFIRST ARG62578 :
    MATCH "[i<len]" -> ASSUME {i == (7);len == (10);} GOTO ARG62579;
    TRUE -> STOP;

STATE USEFIRST ARG62579 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62581;
    TRUE -> STOP;

STATE USEFIRST ARG62581 :
    MATCH "" -> GOTO ARG62582;
    TRUE -> STOP;

STATE USEFIRST ARG62582 :
    MATCH "++i" -> ASSUME {i == (8);} GOTO ARG62583;
    TRUE -> STOP;

STATE USEFIRST ARG62583 :
    MATCH "[i<len]" -> ASSUME {i == (8);len == (10);} GOTO ARG62584;
    TRUE -> STOP;

STATE USEFIRST ARG62584 :
    MATCH "[!(target == arr[i])]" -> GOTO ARG62586;
    TRUE -> STOP;

STATE USEFIRST ARG62586 :
    MATCH "" -> GOTO ARG62587;
    TRUE -> STOP;

STATE USEFIRST ARG62587 :
    MATCH "++i" -> ASSUME {i == (9);} GOTO ARG62588;
    TRUE -> STOP;

STATE USEFIRST ARG62588 :
    MATCH "[i<len]" -> ASSUME {i == (9);len == (10);} GOTO ARG62589;
    TRUE -> STOP;

STATE USEFIRST ARG62589 :
    MATCH "[target == arr[i]]" -> GOTO ARG62590;
    TRUE -> STOP;

STATE USEFIRST ARG62590 :
    MATCH "return i;" -> GOTO ARG62604;
    TRUE -> STOP;

STATE USEFIRST ARG62604 :
    MATCH "" -> GOTO ARG62614;
    TRUE -> STOP;

STATE USEFIRST ARG62614 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (9);} GOTO ARG63299;
    TRUE -> STOP;
...
STATE USEFIRST ARG63488 :
    MATCH "0" -> GOTO ARG63587;
    TRUE -> STOP;
