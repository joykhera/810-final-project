...
entry:
  ...
  %call = call align 16 i8* @malloc(i64 10), !dbg !16
  %0 = bitcast i8* %call to i32*, !dbg !16
  store i32* %0, i32** %p, align 8, !dbg !15
  %1 = load i32*, i32** %p, align 8, !dbg !17
  %incdec.ptr = getelementptr inbounds i32, i32* %1, i32 1, !dbg !17
  store i32* %incdec.ptr, i32** %p, align 8, !dbg !17
  %2 = bitcast i32* %incdec.ptr to i8*, !dbg !17
  call void @free(i8* %2), !dbg !18
  ret i32 0, !dbg !19
}
...
!1 = !DIFile(filename: "code.c", directory: "/results/invalid_free_regression_false-valid-free/klee")
!2 = !{}
...
!13 = !DILocalVariable(name: "p", scope: !9, file: !1, line: 2, type: !14)
!14 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!15 = !DILocation(line: 2, column: 7, scope: !9)
!16 = !DILocation(line: 2, column: 11, scope: !9)
!17 = !DILocation(line: 3, column: 7, scope: !9)
!18 = !DILocation(line: 3, column: 2, scope: !9)
!19 = !DILocation(line: 4, column: 2, scope: !9)
