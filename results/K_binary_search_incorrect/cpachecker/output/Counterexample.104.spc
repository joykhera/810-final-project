CONTROL AUTOMATON ErrorPath104
...
STATE USEFIRST ARG62554 :
    MATCH "[target == arr[i]]" -> GOTO ARG62555;
    TRUE -> STOP;

STATE USEFIRST ARG62555 :
    MATCH "return i;" -> GOTO ARG62597;
    TRUE -> STOP;
...
STATE USEFIRST ARG62607 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (2);} GOTO ARG63292;
    TRUE -> STOP;
...
STATE USEFIRST ARG63482 :
    MATCH "0" -> GOTO ARG63581;
    TRUE -> STOP;
