CONTROL AUTOMATON ErrorPath109
...
STATE USEFIRST ARG62584 :
    MATCH "[target == arr[i]]" -> GOTO ARG62585;
    TRUE -> STOP;

STATE USEFIRST ARG62585 :
    MATCH "return i;" -> GOTO ARG62603;
    TRUE -> STOP;
...
STATE USEFIRST ARG62613 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (8);} GOTO ARG63298;
    TRUE -> STOP;

STATE USEFIRST ARG63298 :
    MATCH "(void) sizeof ((\n# 73 \"code.c\"\n 0\n# 73 \"code.c\" 3 4\n ) ? 1 : 0)" -> GOTO ARG63487;
    TRUE -> STOP;

STATE USEFIRST ARG63487 :
    MATCH "0" -> GOTO ARG63586;
    TRUE -> STOP;
