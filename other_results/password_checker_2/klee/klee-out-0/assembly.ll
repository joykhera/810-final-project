...
@.str.6 = private unnamed_addr constant [11 x i8] c"Welcome 2\0A\00", align 1
@.str.7 = private unnamed_addr constant [28 x i8] c"Error: Incorrect Password \0A\00", align 1
...
if.then:                                          ; preds = %entry
  ...
  %call3 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32 12, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !32
  br label %if.end10, !dbg !33

if.else:                                          ; preds = %entry
  %2 = load i32, i32* %password, align 4, !dbg !34
  %cmp4 = icmp eq i32 %2, 10000, !dbg !36
  br i1 %cmp4, label %if.then5, label %if.else8, !dbg !37

if.then5:                                         ; preds = %if.else
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i64 0, i64 0)), !dbg !38
  %call7 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !40
  br label %if.end10, !dbg !41

if.else8:                                         ; preds = %if.else
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.7, i64 0, i64 0)), !dbg !42
  br label %if.end10
...
!1 = !DIFile(filename: "code.c", directory: "/results/K_password_checker_2/klee")
!2 = !{}
...
!26 = !DILocation(line: 10, column: 7, scope: !27)
!27 = distinct !DILexicalBlock(scope: !9, file: !1, line: 10, column: 7)
!28 = !DILocation(line: 10, column: 16, scope: !27)
!29 = !DILocation(line: 10, column: 7, scope: !9)
!30 = !DILocation(line: 11, column: 5, scope: !31)
!31 = distinct !DILexicalBlock(scope: !27, file: !1, line: 10, column: 27)
!32 = !DILocation(line: 12, column: 3, scope: !31)
!33 = !DILocation(line: 13, column: 3, scope: !31)
!34 = !DILocation(line: 14, column: 12, scope: !35)
!35 = distinct !DILexicalBlock(scope: !27, file: !1, line: 14, column: 12)
!36 = !DILocation(line: 14, column: 21, scope: !35)
!37 = !DILocation(line: 14, column: 12, scope: !27)
!38 = !DILocation(line: 15, column: 5, scope: !39)
!39 = distinct !DILexicalBlock(scope: !35, file: !1, line: 14, column: 31)
!40 = !DILocation(line: 16, column: 3, scope: !39)
!41 = !DILocation(line: 17, column: 3, scope: !39)
!42 = !DILocation(line: 19, column: 5, scope: !35)
!43 = !DILocation(line: 20, column: 3, scope: !9)
