CONTROL AUTOMATON ErrorPath107
...
STATE USEFIRST ARG62574 :
    MATCH "[target == arr[i]]" -> GOTO ARG62575;
    TRUE -> STOP;

STATE USEFIRST ARG62575 :
    MATCH "return i;" -> GOTO ARG62601;
    TRUE -> STOP;

STATE USEFIRST ARG62601 :
    MATCH "" -> GOTO ARG62611;
    TRUE -> STOP;

STATE USEFIRST ARG62611 :
    MATCH "[result != dumb_sort(arr, 10, x)]" -> ASSUME {result == (4);__CPAchecker_TMP_10 == (6);} GOTO ARG63296;
    TRUE -> STOP;
...
STATE USEFIRST ARG63485 :
    MATCH "0" -> GOTO ARG63584;
    TRUE -> STOP;

STATE USEFIRST ARG63584 :
